...
public class BookletPage implements IBookletPage {
    ...
    @Override
    @OnlyIn(Dist.CLIENT)
    public boolean mouseClicked(GuiBookletBase gui, double mouseX, double mouseY, int mouseButton) {
        return false;
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public boolean mouseReleased(GuiBookletBase gui, double mouseX, double mouseY, int state) {
        return false;
    }

    @Override
    @OnlyIn(Dist.CLIENT)
    public boolean mouseDragged(GuiBookletBase gui, double mouseX, double mouseY, int clickedMouseButton, double dragX, double dragY) {
        return false;
    }
