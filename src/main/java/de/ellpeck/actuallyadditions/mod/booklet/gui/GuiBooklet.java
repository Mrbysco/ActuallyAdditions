...
public abstract class GuiBooklet extends GuiBookletBase {
    ...
    public void init() {
        ...
        this.buttonTrials = new TrialsButton(this, btn -> {
            this.getMinecraft().setScreen(new GuiEntry(this.previousScreen, this, ActuallyAdditionsAPI.entryTrials, 0, "", false));
        });
    ...
    public void renderScaledAsciiString(String text, int x, int y, int color, boolean shadow, float scale) {
        this.font.drawWordWrap(new StringTextComponent(text), x, y, 120, 50);
