        ...
        if (this.visible) {
            ...
            if (this.assignedPage != null) {
                ...
                if (StackUtil.isValid(display)) {
                    ...
                    AssetUtil.renderStackToGui(matrices, display, this.x + 2, this.y + 1, 0.725F);
    ...
    public void drawHover(MatrixStack stack, int mouseX, int mouseY) {
        if (this.isMouseOver(mouseX, mouseY)) {
            ...
            if (this.assignedPage != null) {
                ...
                list.add(TextFormatting.GOLD + StringUtil.localize("booklet." + ActuallyAdditions.MODID + ".bookmarkButton.noBookmark"));
